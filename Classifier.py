...
class Classifier(Base.Base):
	...
	analyses = relationship('Analysis', lazy='subquery', back_populates='classifiers')

	def __init__(self, id=0, idPlant=0, tag="", path="", plant=object(), analyses=[], classifier=ClassifierModel()):
		if (classifier.id):
